...
function saveComments(){
    $('#serverstatus').empty().append('Saving comments...' + "&#13;&#10;");

    var title = $('#mptitle').text();
    ...
    $(".comment").each(function(){
        comments.push([$(this).attr('name'),$(this).val()]);
    });
...
function copyComments(obj, num){
    var text = obj.value;
    
    $("#s"+num.toString()).val(text);
    $("#h"+num.toString()).val(text);
}
